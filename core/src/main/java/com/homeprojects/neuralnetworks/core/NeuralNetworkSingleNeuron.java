...
public class NeuralNetworkSingleNeuron {
    ...
    public NeuralNetworkSingleNeuron(SimpleMatrix inputs, SimpleMatrix outputs, SimpleMatrix testInputs, SimpleMatrix testOutputs, int[] layersNeuronsCount, double learningRate) {
        this.inputs = inputs;
    ...
    public NeuralNetworkSingleNeuron(SimpleMatrix io, int numberOfInputColumns, int numberOfOutputColumns, int inputRows, int[] layersNeuronsCount, double learningRate) {
        this(
